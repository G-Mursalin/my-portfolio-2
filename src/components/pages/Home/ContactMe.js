...
const ContactMe = () => {
  return (
    ...
    >
      <div
        className="hero-content grid grid-cols-1 lg:grid-cols-5 p-0"
        id="contact"
      >
        <div className="text-center lg:text-left col-span-5 lg:col-span-2">
          <div className="mb-5">
            ...
            <p className="text-xl leading-relaxed">
              Send me an email if you think I can help you out with any of your
          ...
          <div className="mb-5 lg:mb-0">
            ...
            <div className="grid grid-cols-4">
              <a
                ...
                target="_blank"
                href="https://github.com/G-Mursalin?tab=repositories"
              >
                <img
              ...
              <a
                className="lg:ml-0 mx-auto"
                target="_blank"
                href="https://stackoverflow.com/users/18383531/golam-mursalin"
              >
                <img
                  className="hover:scale-110"
        ...
        <div className="card w-full shadow-2xl bg-base-100 col-span-5 lg:col-span-3">
          <form
            action="https://formsubmit.co/golammursalin309@gmail.com"
            method="POST"
            className="card-body"
          >
